<?php
    ...
    define('_ADMIN_INFOTITLE', '联系信息设置');
    define('_ADMIN_INFO_YES', '是');
    define('_ADMIN_INFO_NO', '否');
    define('_ADMIN_INFO_ENABLE', '是否开启联系信息区域');
    define('_ADMIN_INFO_TITLE', '联系信息区域标题（支持HTML代码）');
    define('_ADMIN_INFO_CONTENT', '联系信息内容（支持HTML代码）');
?>