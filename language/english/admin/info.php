<?php
    ...
    define('_ADMIN_INFOTITLE', 'Information Settings');
    define('_ADMIN_INFO_YES', 'YES');
    define('_ADMIN_INFO_NO', 'NO');
    define('_ADMIN_INFO_ENABLE', 'Enable Contact Information');
    define('_ADMIN_INFO_TITLE', 'Information Title');
    define('_ADMIN_INFO_CONTENT', 'Information Content');
?>